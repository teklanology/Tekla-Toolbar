...
namespace Tekla.Technology.Akit.UserScript
{
	public class Form1 : System.Windows.Forms.Form
	{
        ...
        private void button1_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				Script.GetPhaseAssDrawings(PhaseNumber);
			}
	...
	public class Script
    {
        ...
        public static void GetPhaseAssDrawings(string PhaseNumber)
        {
			// create the phase number and main part filter
			...
			sw.WriteLine("==");
			sw.WriteLine("albl_Equals");
			sw.WriteLine("1");	// this is the setting for primary part
			sw.WriteLine("0");
			sw.WriteLine("Empty");
			sw.WriteLine("}");
			sw.WriteLine("}");
			...
			akit.ValueChange("Drawing_selection", "diaSavedSearchOptionMenu", "10");
